...
var ASM_CONSTS = {
 ...
 306916430: () => document.getElementById("canvas").width,
 306916482: () => parseInt(document.getElementById("canvas").style.width),
 306916550: () => {
 ...
 306916696: () => document.getElementById("canvas").width,
 306916748: () => screen.width,
 306916773: () => {
  document.exitFullscreen();
 },
 306916800: () => {
 ...
 306916979: () => document.getElementById("canvas").width,
 306917031: () => parseInt(document.getElementById("canvas").style.width),
 306917099: () => {
  if (document.fullscreenElement) return 1;
 },
 306917145: () => document.getElementById("canvas").width,
 306917197: () => screen.width,
 306917222: () => {
  if (document.fullscreenElement) return 1;
 },
 306917268: () => document.getElementById("canvas").width,
 306917320: () => screen.width,
 306917345: () => {
  document.exitFullscreen();
 },
 306917372: () => {
 ...
 306917418: () => document.getElementById("canvas").width,
 306917470: () => parseInt(document.getElementById("canvas").style.width),
 306917538: () => {
  document.exitFullscreen();
 },
 306917565: () => screen.width,
 306917590: () => screen.height,
 306917616: () => window.screenX,
 306917643: () => window.screenY,
 306917670: $0 => {
 ...
 306920337: () => (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined),
 306920441: () => {
  try {
 ...
 306923440: $0 => miniaudio.get_device_by_index($0).webaudio.sampleRate,
 306923506: $0 => {
...
var ___start_em_js = Module["___start_em_js"] = 306924193;

var ___stop_em_js = Module["___stop_em_js"] = 306924266;
